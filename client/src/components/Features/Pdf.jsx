...
//   // Then, add new lines when a point starts
//   formattedText = formattedText.replace(/(\d+\.\s)/g, '<br/>$1'); // for 1. 2. 3. 
//   formattedText = formattedText.replace(/(•\s)/g, '<br/>$1'); // for • bullet points
  
//   // Also: replace normal \n from backend with <br/>
